...
angular.core.$timeoutFactory =        function($rootScope,   $browser,   $q,   $exceptionHandler) {
  var deferreds = {};
...
angular.annotate.$inject(['$rootScope', '$browser', '$q', '$exceptionHandler'], angular.core.$timeoutFactory);
